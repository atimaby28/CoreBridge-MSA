...
| **API Gateway** | 13개 서비스 인증 중복 제거 | Spring Cloud Gateway + Cookie JWT 중앙 검증 |
...
| 이력서 + AI 분석 | 채용공고 지원 | 알람 |
|:-:|:-:|:-:|
| ![Resume](docs/screenshots/user-resume.png) | ![Apply](docs/screenshots/user-apply.png) | ![Notificaion](docs/screenshots/user-notification.png) |
...
Frontend (Vue.js :5173)
    ↓
API Gateway (:8000)  ─── JWT 중앙 검증, 라우팅
    ↓
┌─────────────────────────────────────────────────────┐
...
Java 237파일, 테스트 27개 파일 · 226개 메서드 (단위 + 통합)
