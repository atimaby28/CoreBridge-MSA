...
**👉 [https://corebridge.cloud/swagger/index.html](https://corebridge.cloud/swagger/index.html)**

12개 마이크로서비스의 OpenAPI 3.1 명세를 확인할 수 있습니다.
드롭다운에서 서비스를 선택하면 해당 API 엔드포인트, 요청/응답 스키마를 조회할 수 있습니다.

> 총 96개 API 엔드포인트 · 129개 스키마 (정적 문서 — Springdoc OpenAPI 기반 추출)
...
![Dashboard](docs/screenshots/architecture_MSA.png)

<br />

### AI

![Dashboard](docs/screenshots/architecture_AI.png)
...
| 문서 | 설명 |
|------|------|
| [API Documentation](https://corebridge.cloud/swagger/index.html) | 12개 서비스 OpenAPI 명세 (Swagger UI) |
...
Java 257파일, 테스트 46개 파일 · 327개 메서드 (단위 + 통합)
