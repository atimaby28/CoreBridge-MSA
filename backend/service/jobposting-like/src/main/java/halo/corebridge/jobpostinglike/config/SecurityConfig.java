...
import halo.corebridge.jobpostinglike.security.JwtAuthenticationFilter;
    ...
    public SecurityFilterChain filterChain(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeHttpRequests(auth -> auth
                        ...
                        // 좋아요 상태 조회, 좋아요, 좋아요 취소는 인증 필요
                        .requestMatchers("/api/v1/jobposting-likes/**").authenticated()
