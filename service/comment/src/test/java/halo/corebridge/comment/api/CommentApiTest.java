package halo.corebridge.comment.api;
...
class CommentApiTest {
    RestClient restClient = RestClient.create(ApiPaths.HOST + "8003");
...
//          commentId=123694722045702144
    ...
    void read() {
        CommentDto.CommentResponse response = restClient.get()
                .uri(ApiPaths.JOB_COMMENTS + "/{commentId}", 123694721668214784L)
                .retrieve()
                .body(CommentDto.CommentResponse.class);
    ...
    void delete() {
        ...
        restClient.delete()
                .uri(ApiPaths.JOB_COMMENTS + "/{commentId}", 123694722045702144L)
                .retrieve()
                .toBodilessEntity();
    }
    ...
    void readAll() {
        CommentDto.CommentPageResponse response = restClient.get()
                .uri(ApiPaths.JOB_COMMENTS + "?articleId=1&page=1&pageSize=10")
                .retrieve()
