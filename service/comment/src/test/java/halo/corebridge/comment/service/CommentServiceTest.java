...
class CommentServiceTest {
    ...
    void deleteShouldMarkDeletedIfHasChildren() {
        ...
        Long commentId = 2L;
        Comment comment = createComment(jobpostingId, commentId);
    ...
    void deleteShouldDeleteChildOnlyIfNotDeletedParent() {
        ...
        Comment comment = createComment(jobpostingId, commentId, parentCommentId);
    ...
    void deleteShouldDeleteAllRecursivelyIfDeletedParent() {
        ...
        Comment parentComment = createComment(jobpostingId, parentCommentId);
    ...
    private Comment createComment(Long jobpostingId, Long commentId) {
    ...
    private Comment createComment(Long jobpostingId, Long commentId, Long parentCommentId) {
        Comment comment = createComment(jobpostingId, commentId);
