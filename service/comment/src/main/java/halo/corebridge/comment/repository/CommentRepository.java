package halo.corebridge.comment.repository;
...
public interface CommentRepository extends JpaRepository<Comment, Long> {
    ...
    @Query(
            value = "select comment.comment_id, comment.content, comment.parent_comment_id, comment.jobposting_id, " +
                    "comment.writer_id, comment.deleted, comment.created_at " +
                    "from (" +
                    "   select comment_id from comment where jobposting_id = :jobpostingId " +
